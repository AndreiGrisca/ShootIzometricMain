...
namespace nn.account
{
    ...
    public static partial class NetworkServiceAccount
    {
        ...
        public static Result EnsureIdTokenCacheAsync(AsyncContext pOutContext, UserHandle handle)
        {
            return NetworkServiceAccount.EnsureIdTokenCacheAsync(pOutContext._context, handle);
        }

        [DllImport(Nn.DllName,
            CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "nn_account_EnsureNetworkServiceAccountIdTokenCacheAsync")]
        public static extern Result EnsureIdTokenCacheAsync(IntPtr pOutContext, UserHandle handle);
